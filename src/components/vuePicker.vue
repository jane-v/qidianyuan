...
<script>
import provinceData from './city-data/province.1.js'
import cityData from './city-data/city.1.js'
import areaData from './city-data/area.1.js'
export default {
//   props: ['provinceData', 'cityData', 'areaData'],
  data () {
    return {
      pickerValue: [0, 0, 0],
      provinceDataList: [],
  ...
  methods: {
    ...
    pickerChange (e) {
      ...
      if (this.pickerValue[0] !== changePickerValue[0]) {
        ...
        if (areaData[changePickerValue[0]]) {
